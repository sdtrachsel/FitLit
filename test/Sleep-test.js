...
describe('Sleep', () => {
    ...
    it.skip('should store a users sleep logs', function () {
    ...
    it.skip('should find the most recent days data', function () {
        expect(testUser.findMostRecentDay()).to.be.equal("2023/03/24");
    })

    it.skip('should find the overall average of hours slept', function () {
        expect(testUser.findAllTimeAvgOfDetail("hoursSlept")).to.be.equal(7);
    });

    it.skip('should find the overall average of sleep quality', function () {
        expect(testUser.findAllTimeAvgOfDetail("sleepQuality")).to.be.equal(3.1);
    });

    it.skip('should find the number of sleep hours by date', function () {

        expect(testUser.findDetailByDay('2023/03/23', "hoursSlept")).to.be.equal(8.4);
    });

    it.skip('should find the number of sleep quality by date', function () {
        expect(testUser.findDetailByDay('2023/03/16', "sleepQuality")).to.be.equal(2.5);
    });

    it.skip('should be able to tell if a date is valid', function () {
    ...
    it.skip('should be able to find the previous 7 days sleep quality given an end date', function () {
    ...
    it.skip('should be able to find the previous 7 days hours slept given an end date', function () {
    ...
    it.skip('should be able to find if a given date is not valid when finding the previous 7 days detail', function () {
